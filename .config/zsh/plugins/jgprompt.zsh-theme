...
# %F => foreground color (%f to stop) out of 8 colors, vary per machine
# %K => background color (%k to stop)
# %f => reset color
# %~ => current path
# %* => time
# %n => username
# %m => shortname host
# %B => bold (%b to turnoff)
# %S => standout mode, basically invert (%s)
...
prompt_purification_setup() {
    ...
    ZSH_THEME_GIT_PROMPT_PREFIX=" %F{yellow}λ:%f%F{cyan}"
